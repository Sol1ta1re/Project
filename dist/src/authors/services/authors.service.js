...
let AuthorsService = class AuthorsService {
    ...
    async create(createAuthorDto) {
        ...
        if (createAuthorDto.birthYear > currentYear) {
            throw new common_1.BadRequestException('Birth year cannot be in the future');
        }
    ...
    async remove(id) {
        ...
        if (author.books && author.books.length > 0) {
            throw new common_1.ConflictException('Cannot delete author with existing books. Remove books first or reassign them.');
        }
